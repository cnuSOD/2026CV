...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default="D:/Programs/yolo11-self-3/ultralytics-main/datasets/SSDD0.5N/SSDD05N.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default="D:/Programs/yolo11-self-3/runs/YOLOv5n/weights/best.pt", help="model path(s)")
